...
screenKeys = 
  ...
  , ((myModMask .|. mod4Mask, xK_semicolon), windows (W.shift "4"))
  , ((myModMask .|. mod4Mask, xK_q)        , windows (W.shift "2"))
  , ((myModMask .|. mod4Mask, xK_j)        , windows (W.shift "0"))

  , ((myModMask .|. mod4Mask, xK_m)        , windows (W.shift "1"))
  , ((myModMask .|. mod4Mask, xK_w)        , windows (W.shift "3"))
  , ((myModMask .|. mod4Mask, xK_v)        , windows (W.shift "5"))
